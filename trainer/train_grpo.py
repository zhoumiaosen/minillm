# Modified for MiniLLM: shared helpers and completed-epoch resume handling.
import os
import sys
...
from trainer.trainer_utils import training_autocast, Logger, is_main_process, lm_checkpoint, init_distributed_mode, setup_seed, SkipBatchSampler, init_model, LMForRewardModel
...
if __name__ == "__main__":
    ...
    # ========== 3. 设置混合精度 ==========
    autocast_ctx = training_autocast(args.device, args.dtype)
